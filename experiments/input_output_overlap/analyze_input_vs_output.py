...
def main():
    ...
    ap.add_argument("--abl_dir", default="outputs/counterfactual_attribution/ablation")
    ap.add_argument("--output_dir", default="outputs/counterfactual_attribution/analyses/input_vs_output")
