"""
SAE feature ablation utilities.

Provides hooks for ablating selected SAE features at a given submodule and
helpers for computing the resulting change in log-probability of a reference
sequence (Delta p(reference)).
"""
