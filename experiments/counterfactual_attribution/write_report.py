...
ROOT = Path("outputs/counterfactual_attribution")
...
def main():
    ...
    ap("## Merge-back\n")
    ap("Overnight work was merged into `main` on 2026-04-22. Scripts now live "
       "at `experiments/counterfactual_attribution/` and outputs at "
       "`outputs/counterfactual_attribution/`.")
